...
Binary data MUST be encoded as base64 ([RFC 4648](https://www.rfc-editor.org/rfc/rfc4648)) with metadata:
...
Adapters MUST document their configured limits via introspection or adapter documentation.
