...
All public-facing parameters MUST use snake_case naming for consistency across adapters.
...
Operation names MUST use snake_case naming (lowercase letters, digits, and underscores), matching the schema pattern `^[a-z][a-z0-9_]*$`. Operations SHOULD follow the pattern: `{verb}_{resource}`
