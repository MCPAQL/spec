...
| Endpoint routing | Operations routed to the correct documented endpoint family in grouped modes |
...
| Endpoint modes | At least one grouped endpoint mode and Single mode supported |
